...
columnDefs.value = [
{
        ...
        sortable: true,
        filter: true,
        cellRenderer: (params: { data:{ item: string }}) => {
            const span = document.createElement('span');
            span.className = "font-extrabold"; // Add the font-semibold class
            span.innerText = params.data.item; // Set the text
    ...
    {
        headerName: "Score of 3",
        field: 'numberof3',
        sortable: true,
        filter: true
    },
    {
        headerName: "Score of 2",
        field: 'numberof2',
        sortable: true,
        filter: true
    },
    {
        headerName: "Score of 1",
        field: 'numberof1',
        sortable: true,
        filter: true
    },
...
<template>
    ...
    <div class=" pb-2.5">
        <UButton variant="outline" color="sky" label="Download" @click="downloadCsv" />
    </div>
    <div class="rounded-lg grid-container" v-if="toolData">
        <ag-grid-vue style="width: 100%; height: 500px;" @grid-ready="onGridReady" :rowData="toolData"
