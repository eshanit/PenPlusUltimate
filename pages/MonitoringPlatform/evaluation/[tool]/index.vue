    ...
    <UContainer class="py-6 px-4">
      ...
      >
        ...
        <template #description>
          Score each competency based on the provider's performance. Use the scoring guide to ensure consistent assessment across all evaluation items.
        </template>
      </UAlert>
      ...
      <FormsMainEvaluation 
        ...
        :selected-tool="tool" 
        :evaluation-items="evalItems?.evaluationItems" 
        :cut-off="evalItems?.numItems" 
      />
      ...
      <UCard class="mt-6 bg-gradient-to-br from-gray-50 to-blue-50/50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
          <div class="text-center p-3 bg-red-50 rounded-lg border border-red-200">
            <div class="font-bold text-red-700">0 - Not Observed</div>
          ...
          <div class="text-center p-3 bg-orange-50 rounded-lg border border-orange-200">
            <div class="font-bold text-orange-700">1 - Needs Improvement</div>
            <div class="text-orange-600 text-xs mt-1">Basic understanding shown</div>
          </div>
          <div class="text-center p-3 bg-blue-50 rounded-lg border border-blue-200">
            <div class="font-bold text-blue-700">2 - Competent</div>
            <div class="text-blue-600 text-xs mt-1">Skill demonstrated adequately</div>
          </div>
          <div class="text-center p-3 bg-green-50 rounded-lg border border-green-200">
            <div class="font-bold text-green-700">3 - Exemplary</div>
            <div class="text-green-600 text-xs mt-1">Exceptional performance</div>
          </div>
        </div>
      </UCard>
    </UContainer>
